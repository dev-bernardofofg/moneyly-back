...
test.describe('Fluxo Completo de Budgets e Goals E2E', () => {
  ...
  test.describe('Budgets', () => {
    ...
    test('deve atualizar limite de orçamento', async ({ request }) => {
      const response = await request.put(`${API_BASE_URL}/budgets/${budgetId}`, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
        data: {
    ...
    test('deve deletar orçamento', async ({ request }) => {
      ...
      // Deletar
      const deleteResponse = await request.delete(`${API_BASE_URL}/budgets/${tempBudgetId}`, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
      });
  ...
  test.describe('Goals', () => {
    ...
    test('deve adicionar valor à meta', async ({ request }) => {
      const response = await request.post(`${API_BASE_URL}/goals/${goalId}/add-amount`, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
        data: {
    ...
    test('deve deletar meta', async ({ request }) => {
      ...
      // Deletar
      const deleteResponse = await request.delete(`${API_BASE_URL}/goals/${tempGoalId}`, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
      });
    ...
    test('deve calcular progresso com milestones', async ({ request }) => {
      ...
      const getResponse = await request.get(`${API_BASE_URL}/goals/${progressGoalId}`, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
      });
  ...
  test('deve integrar budgets, goals e transações no overview', async ({ request }) => {
