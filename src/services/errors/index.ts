...
export class BadRequestError extends HttpError {
  constructor(message = 'Requisição inválida. Verifique os dados enviados.', details?: unknown) {
...
export class UnauthorizedError extends HttpError {
  constructor(message = 'Autenticação necessária. Por favor, faça login.', details?: unknown) {
