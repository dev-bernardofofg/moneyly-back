...
CREATE TABLE "users" (
	...
	"financial_day_start" integer DEFAULT 1,
	"financial_day_end" integer DEFAULT 31,
...
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_period_id_financial_periods_id_fk" FOREIGN KEY ("period_id") REFERENCES "public"."financial_periods"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_category_preferences" ADD CONSTRAINT "user_category_preferences_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;